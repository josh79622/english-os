...
does not change between sessions and is pasted first, as step 1 of 2. It
tells ChatGPT to acknowledge in one line and wait rather than start.

It is not compressed to fit Custom Instructions. Doing so meant cutting
rules that each exist because a session failed without them, and losing
those costs more than a second paste.
